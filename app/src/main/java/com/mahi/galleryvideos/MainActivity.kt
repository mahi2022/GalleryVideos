package com.mahi.galleryvideos
...
ActivityCompat.requestPermissions(this@MainActivity,
    arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE),111)
        }
    ...
    fun read() {
        var path = "/storage/emulated/0/WhatsApp/Media/WhatsApp Video/"
        var file = File(path)
        if (!file.exists()) {
